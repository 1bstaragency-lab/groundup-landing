...
export const INFLUENCERS: Influencer[] = [
  ...
  { id: 'x34', name: 'HipHopDX Updates',   handle: '@HipHopDXUpdates',    platform: 'Twitter', category: 'Music & News', followers: 48_200,  niche: 'Hip-Hop News',               location: '—', engagementRate: 2.1 },
  { id: 'x35', name: 'StreetCred Blog',    handle: '@streetcredblog',     platform: 'Twitter', category: 'Rap Blog',     followers: 31_700,  niche: 'Underground Reviews',        location: '—', engagementRate: 3.4 },
  { id: 'x36', name: 'NoiseShift',         handle: '@noiseshift',         platform: 'Twitter', category: 'Music & News', followers: 22_400,  niche: 'Music Discovery',            location: '—', engagementRate: 4.2 },
  { id: 'x37', name: 'RapIQDaily',         handle: '@rapiqdaily',         platform: 'Twitter', category: 'Rap Blog',     followers: 19_800,  niche: 'Lyric Analysis',             location: '—', engagementRate: 5.1 },
  { id: 'x38', name: 'CrateDig',           handle: '@cratedigofficial',   platform: 'Twitter', category: 'Music & News', followers: 16_500,  niche: 'Sample Culture',             location: '—', engagementRate: 3.9 },
  { id: 'x39', name: 'Trap Pulse',         handle: '@trappulse__',        platform: 'Twitter', category: 'Music & News', followers: 14_300,  niche: 'Trap & Hip-Hop',             location: '—', engagementRate: 6.3 },
  { id: 'x40', name: 'NewWave Media',      handle: '@newwavemedia_',      platform: 'Twitter', category: 'Music & News', followers: 12_900,  niche: 'Emerging Artists',           location: '—', engagementRate: 4.7 },
  { id: 'x41', name: 'Drip Season',        handle: '@dripseason__',       platform: 'Twitter', category: 'Fashion',      followers: 11_600,  niche: 'Music & Fashion',            location: '—', engagementRate: 8.2 },
  { id: 'x42', name: 'BeatMakers Guild',   handle: '@beatmakersguild',    platform: 'Twitter', category: 'Music & News', followers: 10_400,  niche: 'Producer Culture',           location: '—', engagementRate: 5.5 },
  { id: 'x43', name: 'ReverbNation HQ',    handle: '@reverbnationhq',     platform: 'Twitter', category: 'Music & News', followers: 9_800,   niche: 'Artist Discovery',           location: '—', engagementRate: 3.1 },
  { id: 'x44', name: 'UrbanTone Blog',     handle: '@urbantoneblog',      platform: 'Twitter', category: 'Rap Blog',     followers: 8_700,   niche: 'R&B & Hip-Hop',              location: '—', engagementRate: 4.4 },
  { id: 'x45', name: 'MelancholyRap',      handle: '@melancholyrap',      platform: 'Twitter', category: 'Rap Blog',     followers: 7_900,   niche: 'Emotional Hip-Hop',          location: '—', engagementRate: 7.8 },
  { id: 'x46', name: 'SoundByte Daily',    handle: '@soundbytedaily',     platform: 'Twitter', category: 'Music & News', followers: 7_200,   niche: 'Music News',                 location: '—', engagementRate: 2.9 },
  { id: 'x47', name: 'PluggedIn Blog',     handle: '@pluggedinblog_',     platform: 'Twitter', category: 'Rap Blog',     followers: 6_600,   niche: 'UK Rap & Drill',             location: '—', engagementRate: 5.6 },
  { id: 'x48', name: 'WaxPoetic HQ',       handle: '@waxpoetichq',        platform: 'Twitter', category: 'Music & News', followers: 6_100,   niche: 'Hip-Hop Culture',            location: '—', engagementRate: 4.0 },
  { id: 'x49', name: 'FrescoReviews',      handle: '@frescoreviewss',     platform: 'Twitter', category: 'Rap Blog',     followers: 5_700,   niche: 'Mixtape Reviews',            location: '—', engagementRate: 6.2 },
  { id: 'x50', name: 'BrickCity Sounds',   handle: '@brickcitysounds',    platform: 'Twitter', category: 'Music & News', followers: 5_300,   niche: 'East Coast Hip-Hop',         location: '—', engagementRate: 3.7 },
  { id: 'x51', name: 'HoodReporter',       handle: '@hoodreporter_',      platform: 'Twitter', category: 'Music & News', followers: 5_000,   niche: 'Street Culture',             location: '—', engagementRate: 5.0 },
  { id: 'x52', name: 'GoldChainMedia',     handle: '@goldchainmedia',     platform: 'Twitter', category: 'Music & News', followers: 4_700,   niche: 'Hip-Hop & Rap',              location: '—', engagementRate: 4.3 },
  { id: 'x53', name: 'RealRapTalk',        handle: '@realraptalk__',      platform: 'Twitter', category: 'Rap Blog',     followers: 4_400,   niche: 'Rap Opinion',                location: '—', engagementRate: 9.1 },
  { id: 'x54', name: 'CityFlip Media',     handle: '@cityflipmedia',      platform: 'Twitter', category: 'Music & News', followers: 4_100,   niche: 'Urban Culture',              location: '—', engagementRate: 3.5 },
  { id: 'x55', name: 'MidnightBars',       handle: '@midnightbars_',      platform: 'Twitter', category: 'Rap Blog',     followers: 3_900,   niche: 'Late Night Hip-Hop',         location: '—', engagementRate: 7.2 },
  { id: 'x56', name: 'SoundProof Media',   handle: '@soundproofmedia',    platform: 'Twitter', category: 'Music & News', followers: 3_600,   niche: 'Artist Interviews',          location: '—', engagementRate: 4.8 },
  { id: 'x57', name: 'UnderdogSounds',     handle: '@underdogsounds_',    platform: 'Twitter', category: 'Rap Blog',     followers: 3_400,   niche: 'Unsigned Artists',           location: '—', engagementRate: 6.9 },
  { id: 'x58', name: 'VaultedRap',         handle: '@vaultedrap',         platform: 'Twitter', category: 'Music & News', followers: 3_200,   niche: 'Classic Rap',                location: '—', engagementRate: 3.2 },
  { id: 'x59', name: 'RoadToGold',         handle: '@roadtogold_',        platform: 'Twitter', category: 'Music & News', followers: 3_000,   niche: 'Artist Growth',              location: '—', engagementRate: 5.7 },
  { id: 'x60', name: 'FreestyleForever',   handle: '@freestyleforever_',  platform: 'Twitter', category: 'Rap Blog',     followers: 2_800,   niche: 'Freestyle Culture',          location: '—', engagementRate: 8.4 },
  { id: 'x61', name: 'CurbsideMedia',      handle: '@curbsidemedia',      platform: 'Twitter', category: 'Music & News', followers: 2_600,   niche: 'Underground Rap',            location: '—', engagementRate: 4.1 },
  { id: 'x62', name: 'AllCityBlog',        handle: '@allcityblog_',       platform: 'Twitter', category: 'Rap Blog',     followers: 2_500,   niche: 'Graffiti & Hip-Hop',         location: '—', engagementRate: 5.3 },
  { id: 'x63', name: 'AmpedMedia',         handle: '@ampedmedia__',       platform: 'Twitter', category: 'Music & News', followers: 2_300,   niche: 'Music & Culture',            location: '—', engagementRate: 3.8 },
  { id: 'x64', name: 'ViralRapClips',      handle: '@viralrapclips',      platform: 'Twitter', category: 'Meme Page',    followers: 2_200,   niche: 'Viral Rap Clips',            location: '—', engagementRate: 12.5 },
  { id: 'x65', name: 'BlockMusicBlog',     handle: '@blockmusicblog',     platform: 'Twitter', category: 'Rap Blog',     followers: 2_100,   niche: 'Block Music',                location: '—', engagementRate: 4.6 },
  { id: 'x66', name: 'Slappers Only',      handle: '@slappersonly_',      platform: 'Twitter', category: 'Music & News', followers: 2_000,   niche: 'Best Rap Tracks',            location: '—', engagementRate: 6.1 },
  { id: 'x67', name: 'FinesseTalk',        handle: '@finessetalk_',       platform: 'Twitter', category: 'Music & News', followers: 1_900,   niche: 'Music & Lifestyle',          location: '—', engagementRate: 5.9 },
  { id: 'x68', name: 'DrillReports',       handle: '@drillreports_',      platform: 'Twitter', category: 'Music & News', followers: 1_800,   niche: 'Drill Music News',           location: '—', engagementRate: 7.4 },
  { id: 'x69', name: 'MusicHoodlum',       handle: '@musichoodlum',       platform: 'Twitter', category: 'Rap Blog',     followers: 1_700,   niche: 'Rap Commentary',             location: '—', engagementRate: 6.8 },
  { id: 'x70', name: 'ChainSnatcher',      handle: '@chainsnatcher_',     platform: 'Twitter', category: 'Fashion',      followers: 1_600,   niche: 'Rap Fashion',                location: '—', engagementRate: 9.3 },
  { id: 'x71', name: 'FlyHighMedia',       handle: '@flyhighmedia_',      platform: 'Twitter', category: 'Music & News', followers: 1_550,   niche: 'Music & Culture',            location: '—', engagementRate: 4.5 },
  { id: 'x72', name: 'SoundCheckMag',      handle: '@soundcheckmag_',     platform: 'Twitter', category: 'Music & News', followers: 1_500,   niche: 'Music Magazine',             location: '—', engagementRate: 3.3 },
  { id: 'x73', name: 'RapCompass',         handle: '@rapcompass_',        platform: 'Twitter', category: 'Rap Blog',     followers: 1_450,   niche: 'Rap Navigation',             location: '—', engagementRate: 5.4 },
  { id: 'x74', name: 'MoodMusic Blog',     handle: '@moodmusicblog',      platform: 'Twitter', category: 'Rap Blog',     followers: 1_400,   niche: 'Mood-Based Music',           location: '—', engagementRate: 6.5 },
  { id: 'x75', name: 'NeonLightsMedia',    handle: '@neonlightsmedia',    platform: 'Twitter', category: 'Music & News', followers: 1_350,   niche: 'Music & Nightlife',          location: '—', engagementRate: 4.9 },
  { id: 'x76', name: 'StudioGossip',       handle: '@studiogossip_',      platform: 'Twitter', category: 'Music & News', followers: 1_300,   niche: 'Music Industry Tea',         location: '—', engagementRate: 8.7 },
  { id: 'x77', name: 'ArtistSpotlight',    handle: '@artistspotlight_',   platform: 'Twitter', category: 'Music & News', followers: 1_250,   niche: 'Artist Features',            location: '—', engagementRate: 5.2 },
  { id: 'x78', name: 'HeatSeeker Blog',    handle: '@heatseekerblog',     platform: 'Twitter', category: 'Rap Blog',     followers: 1_200,   niche: 'Hottest Tracks',             location: '—', engagementRate: 7.1 },
  { id: 'x79', name: 'GrittyBeats',        handle: '@grittybeats_',       platform: 'Twitter', category: 'Music & News', followers: 1_150,   niche: 'Beat Makers',                location: '—', engagementRate: 6.0 },
  { id: 'x80', name: 'FreshDropsDaily',    handle: '@freshdropsdaily_',   platform: 'Twitter', category: 'Music & News', followers: 1_100,   niche: 'New Releases',               location: '—', engagementRate: 5.8 },
  { id: 'x81', name: 'SwitchUpMedia',      handle: '@switchupmedia_',     platform: 'Twitter', category: 'Music & News', followers: 1_050,   niche: 'Music Culture',              location: '—', engagementRate: 4.2 },
  { id: 'x82', name: 'BeatArchive',        handle: '@beatarchive_',       platform: 'Twitter', category: 'Music & News', followers: 1_000,   niche: 'Hip-Hop History',            location: '—', engagementRate: 3.6 },
  { id: 'x83', name: 'PaperChaserMag',     handle: '@paperchasermag',     platform: 'Twitter', category: 'Music & News', followers: 970,     niche: 'Music & Money',              location: '—', engagementRate: 4.1 },
  { id: 'x84', name: 'TrapTalk Blog',      handle: '@traptalkblog_',      platform: 'Twitter', category: 'Rap Blog',     followers: 940,     niche: 'Trap Commentary',            location: '—', engagementRate: 7.6 },
  { id: 'x85', name: 'SoloArtist Hub',     handle: '@soloartisthub',      platform: 'Twitter', category: 'Music & News', followers: 910,     niche: 'Independent Artists',        location: '—', engagementRate: 5.1 },
  { id: 'x86', name: 'LateNightTracks',    handle: '@latenighttracks_',   platform: 'Twitter', category: 'Rap Blog',     followers: 880,     niche: 'Late Night Rap',             location: '—', engagementRate: 6.7 },
  { id: 'x87', name: 'ChillWaveRap',       handle: '@chillwaverap_',      platform: 'Twitter', category: 'Rap Blog',     followers: 850,     niche: 'Chill Hip-Hop',              location: '—', engagementRate: 7.3 },
  { id: 'x88', name: 'PlugMedia HQ',       handle: '@plugmediahq',        platform: 'Twitter', category: 'Music & News', followers: 820,     niche: 'Music Plugs',                location: '—', engagementRate: 5.5 },
  { id: 'x89', name: 'RawTalentMedia',     handle: '@rawtalentmedia_',    platform: 'Twitter', category: 'Music & News', followers: 790,     niche: 'Unsigned Talent',            location: '—', engagementRate: 6.2 },
  { id: 'x90', name: 'WestCoastWave',      handle: '@westcoastwave_',     platform: 'Twitter', category: 'Music & News', followers: 760,     niche: 'West Coast Hip-Hop',         location: '—', engagementRate: 4.8 },
  { id: 'x91', name: 'SouthernSound',      handle: '@southernsound_',     platform: 'Twitter', category: 'Music & News', followers: 730,     niche: 'Southern Hip-Hop',           location: '—', engagementRate: 5.3 },
  { id: 'x92', name: 'DrillOrDie Blog',    handle: '@drillordieblg',      platform: 'Twitter', category: 'Rap Blog',     followers: 700,     niche: 'Drill Music',                location: '—', engagementRate: 8.0 },
  { id: 'x93', name: 'HipHopVault',        handle: '@hiphopvault_',       platform: 'Twitter', category: 'Music & News', followers: 670,     niche: 'Hip-Hop Archives',           location: '—', engagementRate: 3.9 },
  { id: 'x94', name: 'MicsUp Media',       handle: '@micsupmedia',        platform: 'Twitter', category: 'Music & News', followers: 640,     niche: 'Artist Spotlights',          location: '—', engagementRate: 5.0 },
