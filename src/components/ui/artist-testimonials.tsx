...
const TESTIMONIALS: Testimonial[] = [
  {
    ...
    after:   '14k MLs',
    metric:  'in 90 days',
    quote:   '"uP pitched the playlist slot I\'d been chasing for a year. Texts me my numbers every morning."',
    accent:  '#FFD700',
  },
  {
    name:    'Mars Lo',
    ...
    quote:   '"The Meta ad uP built ran $20/day and brought new listeners daily. First time I\'ve paid myself for music."',
    accent:  '#60A5FA',
  },
  {
    name:    'KAI',
    ...
    after:   '3 placements',
    metric:  'on 1 release',
    quote:   '"Curators replied the same week. Landed 1 editorial + 2 indie playlists. uP wrote all the pitches."',
    accent:  '#F87171',
  },
  {
    name:    'Naya R.',
    ...
    quote:   '"The comeback pack 3x\'d a song I\'d already given up on. Wish I\'d had this earlier."',
    accent:  '#A78BFA',
  },
  {
    name:    'Theo M.',
  ...
  },
  {
    ...
    initials:'JU',
    before:  '0 sync deals',
    after:   '1 sync placement',
    metric:  'in 6 months',
    quote:   '"Didn\'t even know sync was an option for me. uP flagged 2 supervisors and one closed."',
    accent:  '#FB923C',
  },
]
