...
const liquidbuttonVariants = cva(
  "inline-flex items-center transition-colors justify-center cursor-pointer gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default: "bg-transparent hover:scale-105 duration-300 transition text-[#FFD700]",
        destructive:
    ...
    <>
      ...
      >
        <div className="absolute top-0 left-0 z-0 h-full w-full rounded-full 
            shadow-[0_0_6px_rgba(255,215,0,0.03),0_2px_6px_rgba(255,215,0,0.08),inset_3px_3px_0.5px_-3px_rgba(0,0,0,0.9),inset_-3px_-3px_0.5px_-3px_rgba(0,0,0,0.85),inset_1px_1px_1px_-0.5px_rgba(255,255,255,0.1),inset_-1px_-1px_1px_-0.5px_rgba(255,255,255,0.1),inset_0_0_6px_6px_rgba(255,215,0,0.05),inset_0_0_2px_2px_rgba(255,215,0,0.02),0_0_12px_rgba(255,215,0,0.1)] 
        transition-all 
        dark:shadow-[0_0_8px_rgba(255,215,0,0.03),0_2px_6px_rgba(255,215,0,0.08),inset_3px_3px_0.5px_-3.5px_rgba(255,215,0,0.09),inset_-3px_-3px_0.5px_-3.5px_rgba(255,215,0,0.85),inset_1px_1px_1px_-0.5px_rgba(255,215,0,0.1),inset_-1px_-1px_1px_-0.5px_rgba(255,215,0,0.1),inset_0_0_6px_6px_rgba(255,215,0,0.05),inset_0_0_2px_2px_rgba(255,215,0,0.02),0_0_12px_rgba(255,215,0,0.1)]" />
        <div
          className="absolute top-0 left-0 isolate -z-10 h-full w-full overflow-hidden rounded-md"
          style={{ backdropFilter: 'url("#container-glass")' }}
        />

        <div className="pointer-events-none z-10 font-black uppercase tracking-widest text-[10px]">
          {children}
        </div>
        <GlassFilter />
      </Comp>
